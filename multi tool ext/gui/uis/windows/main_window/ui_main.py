...
# ///////////////////////////////////////////////////////////////
from gui.uis.pages.ui_main_pages import Ui_MainPages, Ui_LoginPages
...
class UI_LoginWindow(object):
    def setup_ui(self, parent):
        ...
        parent.resize(self.settings["login_startup_size"][0], self.settings["login_startup_size"][1])
        parent.setMinimumSize(self.settings["login_minimum_size"][0], self.settings["login_minimum_size"][1])
...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        # ACCOUNTS
        self.load_pages.options.setStyleSheet(f"""
        QFrame#options {{
        ...
        """)
        self.load_pages.footer.setStyleSheet(f"""
        QFrame#footer {{
            background: {self.themes["app_color"]["bg_two"]};
        ...
        # POPUP RESIZE
        # ///////////////////////////////////////////////////////////////
        self.load_pages.page_2.resizeEvent = self.resize_EditSinglePopup

        # ADD CENTRAL WIDGET AND SET CONTENT MARGINS
        # ///////////////////////////////////////////////////////////////
        parent.setCentralWidget(self.central_widget)

    def resize_EditSinglePopup(self, event):
        try:
            self.parent.popup.setGeometry(self.load_pages.page_2.rect())
        except:
            pass
